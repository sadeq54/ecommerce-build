                            ...
                            <div
                                ...
                                <div className='flex flex-col gap-4 sm:flex-row sm:justify-between sm:items-center'>
                                    <div className='flex items-center'>
                                        <span className='text-sm m-2'>Status:</span>
                                        <span
                                    ...
                                    <div className='sm:text-right'>
                                        <p className='text-sm text-gray-600 m-3'>Total Amount</p>
                                        <p className=' m-3 font-bold text-lg'>
                                ...
                                <div className='px-4 py-3  sm:px-6 sm:py-4'>
                                    ...
                                    <div className='space-y-3 sm:space-y-4'>
                                        {order.products?.map((product) => (
                                            <div
                                                key={product._key}
                                                className='flex flex-col sm:flex-row sm:items-center sm:justify-center gap-3 py-2 border-b last:border-b-'
                                            >
                                                <div className='flex items-center gap-3 sm:gap-4'>
                                                    ...
                                                    <div>
                                                        <p className='font-medium text-sm sm:texr-base'>
