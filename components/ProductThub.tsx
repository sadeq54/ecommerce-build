...
export default function ProductThub({ product }: { product: Product }) {
    ...
    return (
        <Link
            ...
            className={`group flex flex-col rounded-lg bg-white w-full border-gray-200 shadow-sm  hover:shadow-md transition-all  duration-200 overflow-hidden ${isOutOfStock ? 'opacity-50' : ''}`}
        >
