...
// Query: *[_type == "order" && clerckUserId == $userId]  | order(orderDate desc)          {            ...,    // Spread all order fields            products[]{  // Array of products                ...,  // Spread product fields                product->  // Reference expansion            }          }
...
declare module "@sanity/client" {
  interface SanityQueries {
    ...
    "\n    *[\n    _type == \"sales\"\n     && couponCode == $couponCode\n     && isActive == true] | order(validFrom desc) [0]": ACTIVE_SALE_BY_COUPON_CODE_QUERYResult;
  }
}
